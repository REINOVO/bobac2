...
rm /usr/lib/libOpenNI2.so*
rm /usr/lib/OpenNI2/Drivers/*
install -T libOpenNI2.so /usr/lib/libOpenNI2.so && echo "openni2 installed"
ln /usr/lib/libOpenNI2.so /usr/lib/libOpenNI2.so.0
...
cp -rf --remove-destination NiTE2 ${HOME}/.ros/ && echo "cp NiTE2" 
cp -f --remove-destination NiTE.ini ${HOME}/.ros/
