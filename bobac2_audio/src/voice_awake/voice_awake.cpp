...
#define LOGIN_PARAMS  "appid = 5d536221, work_dir = ./voice_config/voice_awake"//登录参数,appid与msc库绑定,请勿随意改动
...
bool awake_cb(bobac2_audio::Awake::Request &req, bobac2_audio::Awake::Response &res){
  std::string text;
  text = run_iat(req.voice_filename.c_str(), SESSION_BEGIN_PARAMS);//获取识别的文本
  if(text.find("元宝元宝") != std::string::npos){
    res.awake_flag= true;
  }
